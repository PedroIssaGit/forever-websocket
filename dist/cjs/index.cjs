...
exports.ForeverWebSocket = void 0;
...
class ForeverWebSocket extends _eventemitter.default {
  ...
  constructor(address, protocol, options) {
    ...
    for (const propertyName of propertyNames) {
      ...
      if (isMethod(_ws.default.prototype, propertyName)) {
    ...
    function createReconnectFactory({
      ...
      randomizeDelay = true,
      factor = 1.5
    } = {}, callbackStartConnect, callbackStartDelay) {
  ...
  connect() {
    ...
    if (this.#optionsExtended.newWebSocket) {
      ...
      this.ws = new _ws.default(this.#address, this.#protocol, this.#optionsWebSocket);
    }
...
exports.ForeverWebSocket = ForeverWebSocket;
